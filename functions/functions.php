...
function single_post(){
	if (isset($_GET['post_id'])) {
		...
		if ($p_id != $post_id) {
			...
			echo "<script>window.opent('home.php' , '_self')</script>";
		}else{
			if($content=="No" && strlen($upload_image) >= 1){
			echo"
			<div class='row'>
		...
		<div class='row'>
			<div class='col-sm-9 col-md--offset-3'>
				<div style='margin-left:34%' class='panel panel-info'>
		...
		<div class='row'>
			...
			<div class='col-sm-6'>
				<div class='row' id='find_people'>
					...
					<div class='col-sm-6'>
						<a style='text-decoration:; cursor:pointer; color:#3897f0' href='user_profile.php?user_id=$user_id'>
