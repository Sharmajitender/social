...
?>
  	...
  	<?php
        ...
        echo"
          <div class='container-fluid'>
              ...
              <img class='img-circle' src='users/$user_image' width='90px' height='80px' title='$user_name'><stong>&nbsp $first_name $last_name</stong><br><br>
            </a>
          </div>
        ";
  ...
  <div class="col-sm-6">
	 <div class="load_msg" id="scroll_messages">
		...
		<div id="loaded_msg">
			<p><?php if($user_to == $user_to_msg AND $user_from == $user_from_msg){echo "<div class='message' id='blue' date-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";}
...
?>
  ...
  <div class="col-sm-3">
  	<?php
        ...
        $register_data = $row['user_reg_date'];
